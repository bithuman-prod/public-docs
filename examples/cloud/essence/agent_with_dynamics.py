...
def detect_keyword_action(transcript: str, keyword_map: Dict[str, str]) -> Optional[str]:
    """
...
async def entrypoint(ctx: JobContext):
    ...
    logger.info("✅ Agent session started with VAD-based interruption and dynamics support")
